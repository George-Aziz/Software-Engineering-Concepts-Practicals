...
/**************************************************************************************************
 * Author: George Aziz
 * Purpose: Manages dialog box for adding new timetable entries which are dynamically validated
...
public class AddUI
{
    ...
    public void addEntry()
    {
        if(dialog == null)
        {
            ...
            content.add(new Label(bundle.getString("route_label")),           0, 0);
            content.add(new Label(bundle.getString("from_label")),               0, 1);
            content.add(new Label(bundle.getString("destination_label")),        0, 2);
            content.add(new Label(bundle.getString("departure_label")),     0, 3);
            content.add(new Label(bundle.getString("duration_label")), 0, 4);
